...
#include "../../../drogon_models/movement_history_model/MovementHistory.h"
...
private:
    ...
    std::shared_ptr<drogon::orm::Mapper<drogon_model::cms_simulator_db::MovementHistory>> movement_history_mapper_;
};
