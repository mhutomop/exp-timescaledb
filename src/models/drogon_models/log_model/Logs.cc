...
const std::string Logs::Cols::_time = "\"time\"";
const std::string Logs::Cols::_session_id = "\"session_id\"";
const std::string Logs::Cols::_simulator_id = "\"simulator_id\"";
const std::string Logs::Cols::_object_id = "\"object_id\"";
const std::string Logs::Cols::_latitude_bearing = "\"latitude_bearing\"";
const std::string Logs::Cols::_longitude_range = "\"longitude_range\"";
const std::string Logs::primaryKeyName = "";
const bool Logs::hasPrimaryKey = false;
const std::string Logs::tableName = "\"logs\"";

const std::vector<typename Logs::MetaData> Logs::metaData_={
...
const std::string &Logs::getColumnName(size_t index) noexcept(false)
{
    assert(index < metaData_.size());
    return metaData_[index].colName_;
}
Logs::Logs(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        if(!r["time"].isNull())
...
Logs::Logs(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[1].empty() && pJson.isMember(pMasqueradingVector[1]))
    {
        ...
        {
            sessionId_=std::make_shared<int32_t>((int32_t)pJson[pMasqueradingVector[1]].asInt64());
        }
    }
    if(!pMasqueradingVector[2].empty() && pJson.isMember(pMasqueradingVector[2]))
    {
        ...
        {
            simulatorId_=std::make_shared<int32_t>((int32_t)pJson[pMasqueradingVector[2]].asInt64());
        }
    }
...
Logs::Logs(const Json::Value &pJson) noexcept(false)
{
...
void Logs::updateByMasqueradedJson(const Json::Value &pJson,
...
void Logs::updateByJson(const Json::Value &pJson) noexcept(false)
{
    if(pJson.isMember("time"))
    {
        dirtyFlag_[0] = true;
...
const ::trantor::Date &Logs::getValueOfTime() const noexcept
{
...
const std::shared_ptr<::trantor::Date> &Logs::getTime() const noexcept
{
    return time_;
}
void Logs::setTime(const ::trantor::Date &pTime) noexcept
{
    time_ = std::make_shared<::trantor::Date>(pTime);
    dirtyFlag_[0] = true;
}

const int32_t &Logs::getValueOfSessionId() const noexcept
{
...
const std::shared_ptr<int32_t> &Logs::getSessionId() const noexcept
{
    return sessionId_;
}
void Logs::setSessionId(const int32_t &pSessionId) noexcept
{
    sessionId_ = std::make_shared<int32_t>(pSessionId);
    dirtyFlag_[1] = true;
}

const int32_t &Logs::getValueOfSimulatorId() const noexcept
{
    static const int32_t defaultValue = int32_t();
    if(simulatorId_)
        return *simulatorId_;
...
const std::shared_ptr<int32_t> &Logs::getSimulatorId() const noexcept
{
    return simulatorId_;
}
void Logs::setSimulatorId(const int32_t &pSimulatorId) noexcept
{
    simulatorId_ = std::make_shared<int32_t>(pSimulatorId);
    dirtyFlag_[2] = true;
}

const int32_t &Logs::getValueOfObjectId() const noexcept
{
    static const int32_t defaultValue = int32_t();
    if(objectId_)
        return *objectId_;
...
const std::shared_ptr<int32_t> &Logs::getObjectId() const noexcept
{
    return objectId_;
}
void Logs::setObjectId(const int32_t &pObjectId) noexcept
{
    objectId_ = std::make_shared<int32_t>(pObjectId);
    dirtyFlag_[3] = true;
}

const double &Logs::getValueOfLatitudeBearing() const noexcept
{
...
const std::shared_ptr<double> &Logs::getLatitudeBearing() const noexcept
{
    return latitudeBearing_;
}
void Logs::setLatitudeBearing(const double &pLatitudeBearing) noexcept
{
    latitudeBearing_ = std::make_shared<double>(pLatitudeBearing);
    dirtyFlag_[4] = true;
}

const double &Logs::getValueOfLongitudeRange() const noexcept
{
    static const double defaultValue = double();
    if(longitudeRange_)
...
const std::shared_ptr<double> &Logs::getLongitudeRange() const noexcept
{
    return longitudeRange_;
}
void Logs::setLongitudeRange(const double &pLongitudeRange) noexcept
{
    longitudeRange_ = std::make_shared<double>(pLongitudeRange);
    dirtyFlag_[5] = true;
}

void Logs::updateId(const uint64_t id)
{
}

const std::vector<std::string> &Logs::insertColumns() noexcept
{
...
void Logs::outputArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[0])
    {
        if(getTime())
...
const std::vector<std::string> Logs::updateColumns() const
{
...
void Logs::updateArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[0])
    {
        if(getTime())
...
Json::Value Logs::toMasqueradedJson(
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 6)
    {
        ...
        if(!pMasqueradingVector[2].empty())
        {
            if(getSimulatorId())
            {
                ret[pMasqueradingVector[2]]=getValueOfSimulatorId();
            }
            else
            {
...
bool Logs::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("time"))
    {
    ...
    if(pJson.isMember("simulator_id"))
    {
        if(!validJsonOfField(2, "simulator_id", pJson["simulator_id"], err, true))
            return false;
    }
    else
    {
...
bool Logs::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool Logs::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("time"))
    {
    ...
    if(pJson.isMember("simulator_id"))
    {
        if(!validJsonOfField(2, "simulator_id", pJson["simulator_id"], err, false))
            return false;
    }
    if(pJson.isMember("object_id"))
    {
...
bool Logs::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                            const std::vector<std::string> &pMasqueradingVector,
                                            std::string &err)
{
    if(pMasqueradingVector.size() != 6)
...
bool Logs::validJsonOfField(size_t index,
